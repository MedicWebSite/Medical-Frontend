    ...
    <div className="hero">
      ...
      >
        ...
        <div className="hero-content">
          <p data-aos="fade-up"  data-aos-duration='1000' className="content-subtitle">{image.subtitle}</p>
          <h2 data-aos="fade-up" data-aos-duration='1500' data-aos-offset="200"  className='content-title'>{image.main_title}</h2>
          <div data-aos="fade-up" data-aos-duration='1500'  className="content-links">
            <Link className='content-link' >CONTACT US &nbsp; + </Link>
